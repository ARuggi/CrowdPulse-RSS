...
class Sole24XmlParser(XmlParser):
    ...
    def parse(self):
        ...
        for channel in rss.find_all("channel"):
            ...
            result = Sole24Channel(title, description, link, language)

            for item in channel.find_all_next("item"):
                result.add_item(Sole24Item(
