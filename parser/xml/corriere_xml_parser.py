...
class CorriereXmlParser(XmlParser):
    ...
    def parse(self):
        ...
        for channel in rss.find_all("channel"):
            ...
            result = CorriereChannel(title, description, link, language)

            for item in channel.find_all_next("item"):
                result.add_item(CorriereItem(
