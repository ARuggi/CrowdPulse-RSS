...
class TheSunXmlParser(XmlParser):
    ...
    def parse(self):
        ...
        for channel in rss.find_all("channel"):
            ...
            language = "en"
            result = TheSunChannel(title, description, link, language)

            for item in channel.find_all_next("item"):
                result.add_item(TheSunItem(
