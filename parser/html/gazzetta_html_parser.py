...
# parser for https://www.lagazzettadelmezzogiorno.it/news/...
class GazzettaHtmlParser(HtmlParser):
    ...
    def perform_request(self):
        ...
        content = fix_content_text(soup.find_all(attrs={"class": "testo_articolo testo testoResize"})[0].text)
